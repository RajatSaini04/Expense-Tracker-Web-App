...
const Expense = () => {
  ...
  const handleAddExpense = async (expense) => {
    ...
    try {
      ...
      const msg = error.response?.data?.message || (editingExpense ? "Failed to update expense" : "Failed to add expense");
      toast.error(msg);
    }
  };
  ...
  return (
    <DashboardLayout activeMenu="Expense">
      <div className="my-5 mx-auto">
        ...
        >
          <DeleteAlert
            content="Are you sure you want to delete this expense? It will be moved to Archived Transactions."
